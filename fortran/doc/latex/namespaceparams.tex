...
real(kind=8) \hyperlink{namespaceparams_a9abc30794d97348ca8f129e052f50630}{rescaling\+\_\+time}
...
Definition at line 99 of file params.\+f90.


\begin{DoxyCode}
99     \textcolor{keywordtype}{INTEGER} :: allocstat
100 
101     namelist /aoscale/  scale,f0,n,rra,phi0\_npi
102     namelist /oparams/  gp,r,h,d,nuo
103     namelist /aparams/  k,kp,sig0,nua
104     namelist /toparams/ go,co,to0
105     namelist /taparams/ ga,ca,epsa,ta0
106     namelist /otparams/ sc,lambda,rr,sb
107 
108     namelist /modeselection/ oms,ams
109     namelist /numblocs/ nboc,nbatm
110 
111     namelist /int\_params/ t\_trans,t\_run,dt,tw,writeout
112     namelist /lyap\_params/ rescaling\_time
113 
114     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"params.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
115 
116     \textcolor{keyword}{READ}(8,nml=aoscale)
117     \textcolor{keyword}{READ}(8,nml=oparams)
118     \textcolor{keyword}{READ}(8,nml=aparams)
119     \textcolor{keyword}{READ}(8,nml=toparams)
120     \textcolor{keyword}{READ}(8,nml=taparams)
121     \textcolor{keyword}{READ}(8,nml=otparams)
122 
123     \textcolor{keyword}{CLOSE}(8)
124 
125     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"modeselection.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
126     \textcolor{keyword}{READ}(8,nml=numblocs)
127 
128     \textcolor{keyword}{ALLOCATE}(oms(nboc,2),ams(nbatm,2), \hyperlink{namespacestat}{stat}=allocstat)
129     \textcolor{keywordflow}{IF} (allocstat /= 0) stop \textcolor{stringliteral}{"*** Not enough memory ! ***"}
130 
131     \textcolor{keyword}{READ}(8,nml=modeselection)
132     \textcolor{keyword}{CLOSE}(8)
133 
134     \textcolor{keyword}{OPEN}(8, file=\textcolor{stringliteral}{"int\_params.nml"}, status=\textcolor{stringliteral}{'OLD'}, recl=80, delim=\textcolor{stringliteral}{'APOSTROPHE'})
135     \textcolor{keyword}{READ}(8,nml=int\_params)
136     \textcolor{keyword}{READ}(8,nml=lyap\_params)
137 
\end{DoxyCode}
...
Definition at line 142 of file params.\+f90.


\begin{DoxyCode}
142     \textcolor{keywordtype}{INTEGER}, \textcolor{keywordtype}{DIMENSION(2)} :: s
143     \textcolor{keywordtype}{INTEGER} :: i
144     \textcolor{keyword}{CALL }init\_nml
145 
146     \textcolor{comment}{!---------------------------------------------------------!}
147     \textcolor{comment}{!                                                         !}
148     \textcolor{comment}{! Computation of the dimension of the atmospheric         !}
149     \textcolor{comment}{! and oceanic components                                  !}
150     \textcolor{comment}{!                                                         !}
151     \textcolor{comment}{!---------------------------------------------------------!}
152 
153     natm=0
154     \textcolor{keywordflow}{DO} i=1,nbatm
155        \textcolor{keywordflow}{IF} (ams(i,1)==1) \textcolor{keywordflow}{THEN}
156           natm=natm+3
...
162     noc=s(1)
163 
164     ndim=2*natm+2*noc
165 
166     \textcolor{comment}{!---------------------------------------------------------!}
167     \textcolor{comment}{!                                                         !}
168     \textcolor{comment}{! Some general parameters (Domain, beta, gamma, coupling) !}
169     \textcolor{comment}{!                                                         !}
170     \textcolor{comment}{!---------------------------------------------------------!}
171 
172     pi=dacos(-1.d0)
173     l=scale/pi
174     phi0=phi0\_npi*pi
175     lr=sqrt(gp*h)/f0
176     g=-l**2/lr**2
177     betp=l/rra*cos(phi0)/sin(phi0)
178     rp=r/f0
179     dp=d/f0
180     kd=k*2
181     kdp=kp
...
185     \textcolor{comment}{! DERIVED QUANTITIES                                  !}
186     \textcolor{comment}{!                                                     !}
187     \textcolor{comment}{!-----------------------------------------------------!}
188 
189     cpo=co/(go*f0) * rr/(f0**2*l**2)
190     lpo=lambda/(go*f0)
191     cpa=ca/(ga*f0) * rr/(f0**2*l**2)/2 \textcolor{comment}{! Cpa acts on psi1-psi3, not on theta}
192     lpa=lambda/(ga*f0)
193     sbpo=4*sb*to0**3/(go*f0) \textcolor{comment}{! long wave radiation lost by ocean to atmosphere space}
194     sbpa=8*epsa*sb*ta0**3/(go*f0) \textcolor{comment}{! long wave radiation from atmosphere absorbed by ocean}
195     lsbpo=2*epsa*sb*to0**3/(ga*f0) \textcolor{comment}{! long wave radiation from ocean absorbed by atmosphere}
196     lsbpa=8*epsa*sb*ta0**3/(ga*f0) \textcolor{comment}{! long wave radiation lost by atmosphere to space & ocea}
197     nuap=nua/(f0*l**2)
198     nuop=nuo/(f0*l**2)
199 
\end{DoxyCode}
...
Definition at line 89 of file params.\+f90.


\begin{DoxyCode}
89   \textcolor{keywordtype}{INTEGER}, \textcolor{keywordtype}{DIMENSION(:,:)}, \textcolor{keywordtype}{ALLOCATABLE} :: ams\textcolor{comment}{   !< Atmospheric mode selection array}
\end{DoxyCode}
...
\begin{DoxyCode}
85   \textcolor{keywordtype}{INTEGER} :: natm=0\textcolor{comment}{ !< Number of atmospheric basis functions}
\end{DoxyCode}
...
\begin{DoxyCode}
84   \textcolor{keywordtype}{INTEGER} :: nbatm\textcolor{comment}{  !< Number of oceanic blocks}
\end{DoxyCode}
...
\begin{DoxyCode}
83   \textcolor{keywordtype}{INTEGER} :: nboc\textcolor{comment}{   !< Number of atmospheric blocks}
\end{DoxyCode}
...
\begin{DoxyCode}
87   \textcolor{keywordtype}{INTEGER} :: ndim\textcolor{comment}{   !< Number of variables (dimension of the model)}
\end{DoxyCode}
...
\begin{DoxyCode}
86   \textcolor{keywordtype}{INTEGER} :: noc=0\textcolor{comment}{  !< Number of oceanic basis functions}
\end{DoxyCode}
...
Definition at line 88 of file params.\+f90.


\begin{DoxyCode}
88   \textcolor{keywordtype}{INTEGER}, \textcolor{keywordtype}{DIMENSION(:,:)}, \textcolor{keywordtype}{ALLOCATABLE} :: oms\textcolor{comment}{   !< Ocean mode selection array}
\end{DoxyCode}
...
\end{DoxyCode}
\index{params@{params}!rescaling\+\_\+time@{rescaling\+\_\+time}}
\index{rescaling\+\_\+time@{rescaling\+\_\+time}!params@{params}}
\subsubsection[{\texorpdfstring{rescaling\+\_\+time}{rescaling_time}}]{\setlength{\rightskip}{0pt plus 5cm}real(kind=8) params\+::rescaling\+\_\+time}\hypertarget{namespaceparams_a9abc30794d97348ca8f129e052f50630}{}\label{namespaceparams_a9abc30794d97348ca8f129e052f50630}


Rescaling time for the Lyapunov computation. 
...
\begin{DoxyCode}
81   \textcolor{keywordtype}{REAL(KIND=8)} :: rescaling\_time\textcolor{comment}{ !< Rescaling time for the Lyapunov computation}
\end{DoxyCode}
